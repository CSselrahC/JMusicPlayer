...
public class jmpTrinity extends JFrame {
	...
	public jmpTrinity() {
		...
		upButton.setBounds(155, 297, 90, 25);
		upButton.setEnabled(false);
		...
		downButton.setBounds(155, 333, 90, 25);
		downButton.setEnabled(true);
		...
		addButton.setBounds(300, 297, 90, 25);
		...
		playButton.setBounds(155, 241, 90, 25);
		playButton.setEnabled(false);
		...
		loopOneButton.setBounds(300, 353, 90, 25);
		loopOneButton.setEnabled(false);
		...
		volumePanel.setBounds(10, 225, 80, 225);
		...
		volumeSlider.setBounds(20, 36, 20, 153);
		...
		muteButton.setBounds(0, 200, 80, 25);
		...
		loopAllButton.setBounds(300, 389, 90, 25);
		...
		shuffleButton.setBounds(300, 425, 90, 25);
