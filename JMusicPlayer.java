...
public class JMusicPlayer extends JFrame {
	...
	JButton upButton, downButton, addButton, playButton, loopButton, muteButton;
	...
	public JMusicPlayer() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (rowOfSelectedSong > 1) {
					...
					if (model.getValueAt(table.getSelectedRow(), 1) != null) {
						...
						loopButton.setBackground(new Color(25, 20, 20));
					}
		...
		loopButton.setBackground(new Color(25, 20, 20));
		loopButton.setForeground(new Color(25, 20, 20));
		...
		loopButton.setBounds(300, 277, 90, 25);
		loopButton.setEnabled(false);
